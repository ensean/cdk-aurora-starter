...
class Aurora(Stack):
  ...
  def __init__(self, scope:Construct, id:str,
                ...
                engine:str="mysql",    ## Aurora Database Engine: postgresql or mysql
    ...
    ##
    aurora_engine = rds.DatabaseClusterEngine.aurora_mysql(version=rds.AuroraMysqlEngineVersion.VER_2_10_2)

    aurora_parameters = {}
    
    # parameters for aurora
    aurora_parameters["binlog_format"] = "ROW"
    aurora_parameters["slow_query_log"] = "1"   # enable slow query log
    aurora_parameters["long_query_time"] = "2"  # slow query threshlod, seconds
    ...
    aurora_cluster = rds.DatabaseCluster(self, "AuroraDatabase",
        engine = aurora_engine,
        credentials = aurora_cluster_credentials, # TODO Optional - will default to 'admin' username and generated password
